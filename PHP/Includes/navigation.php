 ...
 <div id="titleContainer">
  <div class="titleBar">
      ...
      <button type="button" class="titleItems clickable" id="burgerMenuButton">
           <span id="hamburgerLine" class=""></span>
      </button>
  </div>
</div> 
  <div class="searchBar">
        ...
        <div class="mainNavBar mainNavBarPosition" id="masterNavBar">
            <div class="navOptions">
                            ...
                            <div class="subMenuOption" id="subBespoke">
                                ...
                                <div class="subMenuLinks">
                                     ...
                                     <a href="" class="subMenuLinkOption">
                                        ...
                                        <h4>Business Central Implementation</h4>                                   
                                     </a>
                                     <a href="" class="subMenuLinkOption">
                                        <i class="fa-solid fa-users"></i>
                                        <h4>Internet of Things &#40;IoT&#41; Software</h4>                                   
                                     </a>
                                     <a href="" class="subMenuLinkOption">
                                        <i class="fa-solid fa-cloud"></i>
                                        <h4>Intranet Development</h4>                                   
                                     </a>
                                     <a href="" class="subMenuLinkOption">
                                        <i class="fa-solid fa-cloud-arrow-down"></i>
                                        <h4>Customer Portal Development</h4>                                   
                                     </a>
                                     <a href="" class="subMenuLinkOption">
                ...
                <button type="button" class="navItem clickable" id="optionSupport">
                    ...
                    <div class="navSubMenuContainer">
                        <div class="navSubMenu">
                            <div class="subMenuOption" id="subSupport">
                                <div class="subMenuTitle">
                                ...
                                <div class="subMenuLinks">
                                     ...
                                     <a href="" class="subMenuLinkOption">
                                        ...
                                        <h4>Data Backup &#38; Diaster Recovery</h4>                                   
                                     </a>
                                </div>    
                            </div> 
                ...
                <button type="button" class="navItem clickable" id="optionMarketing">
                    ...
                    <div class="navSubMenuContainer">
                        <div class="navSubMenu">
                            <div class="subMenuOption" id="subMarketing">
                                <div class="subMenuTitle">
                                ...
                                <div class="subMenuLinks">
                                     ...
                                     <a href="" class="subMenuLinkOption">
                                        ...
                                        <h4>Conversation Rate Optimisation &#40;CRO&#41;</h4>                                   
                                     </a>
                                     <a href="" class="subMenuLinkOption">
                ...
                <button type="button" class="navItem clickable" id="optionTelecom">
                    ...
                    <div class="navSubMenuContainer">
                        <div class="navSubMenu">
                            <div class="subMenuOption" id="subTelecom">
                                <div class="subMenuTitle">
                                    <h2>Our Telecom Services</h2>
                                </div>
                                <div class="subMenuLinks">
                                     <a href="" class="subMenuLinkOption">
                                        <i class="fa-solid fa-ticket"></i>
                                        <h4>Business Mobile</h4>                                   
                                     </a>
                                     <a href="" class="subMenuLinkOption">
                                        <i class="fa-solid fa-phone"></i>
                                        <h4>Hosted VoIP Provider</h4>                                   
                                     </a>
                                     <a href="" class="subMenuLinkOption">
                                        <i class="fa-solid fa-square-phone"></i>
                                        <h4>Business VoIP Systems</h4>                                   
                                     </a>
                                     <a href="" class="subMenuLinkOption">
                                        <i class="fa-solid fa-gauge-high"></i>
                                        <h4>Business Broadband</h4>                                   
                                     </a>
                                     <a href="" class="subMenuLinkOption">
                                        <i class="fa-regular fa-handshake"></i>
                                        <h4>Leased Lines Provider</h4>                                   
                                     </a>
                                     <a href="" class="subMenuLinkOption">
                ...
                <button type="button" class="navItem clickable" id="optionDesign">
                    ...
                    <div class="navSubMenuContainer">
                        <div class="navSubMenu">
                            <div class="subMenuOption" id="subDesign">
                                <div class="subMenuTitle">
                            ...
                            <div class="subMenuOption" id="subSecurity">
                                ...
                                <div class="subMenuLinks">
                                     <a href="" class="subMenuLinkOption">
                                        ...
                                        <h4>Cyber Security Assessment</h4>                                   
                                     </a>
                                     <a href="" class="subMenuLinkOption">
                                     ...
                                     <a href="" class="subMenuLinkOption">
                                        <i class="fa-solid fa-desktop"></i>
                                        <h4>Cyber Penetration Testing</h4>                                   
                                     </a>
                                     <a href="" class="subMenuLinkOption">
                                        <i class="fa-solid fa-graduation-cap"></i>
                                        <h4>Cyber Essentials Certification</h4>                                   
                                     </a>
                                     <a href="" class="subMenuLinkOption">
...
<div class="sideMenuContainer sideMenuHide">
            <div id="sideMenuServices" class="sideMenuOption">
            ...
            <div id="sideMenuContactUs" class="sideMenuOption">
                <div class="sideMenuTopSection">
                    <a href="https://netmatters.celestin-jacobs.netmatters-scs.co.uk/PHP/Site%20Pages/contact-us.php">CONTACT US</a>
                </div>
        ...
        <div id="mobileSideMenuContainer" class="sideMenuHide">
            <div id="mobileSMenuContact">
                <a href="">CONTACT US</a>
            </div>

            <div id="mobileSMenuBespoke" class="mobileSMenuOption">
                <div class="mobileSMenuTopSection">
                    <i class="fa-solid fa-laptop"></i>
                    <h4>BESPOKE</h4>
                    <h3>SOFTWARE</h3>
                </div>
            ...
            <div id="mobileSMenuSupport" class="mobileSMenuOption">
                <div class="mobileSMenuTopSection">
                    <i class="fa-solid fa-desktop"></i>
                    <h4>IT</h4>
                    <h3>SUPPORT</h3>
            ...
            <div id="mobileSMenuMarketing" class="mobileSMenuOption">
                <div class="mobileSMenuTopSection">
            ...
            <div id="mobileSMenuTelecoms" class="mobileSMenuOption">
                <div class="mobileSMenuTopSection">
                    <i class="fa-solid fa-phone-volume"></i>
                    <h4>TELECOMS</h4>
                    <h3>SERVICES</h3>
            ...
            <div id="mobileSMenuDesign" class="mobileSMenuOption">
                <div class="mobileSMenuTopSection">
                    <i class="fa-solid fa-code"></i>
                    <h4>WEB</h4>
                    <h3>DESIGN</h3>
            ...
            <div id="mobileSMenuSecurity" class="mobileSMenuOption">
                <div class="mobileSMenuTopSection">
                    <i class="fa-solid fa-shield-halved"></i>
                    <h4>CYBER</h4>
                    <h3>SECURITY</h3>
            ...
            <div id="mobileSMenuCourse" class="mobileSMenuOption">
                <div class="mobileSMenuTopSection">
                    <i class="fa-solid fa-graduation-cap"></i>
                    <h4>DEVELOPER</h4>
                    <h3>COURSE</h3>
